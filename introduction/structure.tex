...
Within this region, the gas has almost no thermal pressure support ($v_{rms} < 0.5 \kms$), and is mainly supported by turbulent motions \citep{larson_turbulence_1981, solomon_mass_1987, heyer_universality_2004} with dispersion $\sigma \approx 1 \kms$.
...
\begin{table}[hb]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{lcccc}
            Phase & $T$ [K] & $\rho$ [$n_H \cm^{-3}$]& Scale height [pc] & Observations \\ \hline
            Molecular  & $10 - 20$ & $10^2 - 10^6$ & $<100$ & Traced by CO (radio) and IR \\
            Neutral Atomic  & $50 - 10000$ & $0.2 - 50$ & $\approx 100$ & Ly$\alpha$ and HI 21 cm radiation \\
            Warm Ionized  & $\approx 8000$ & $0.2 - 0.5$ & $\approx 300$ & H$\alpha$ \\
            Hot Ionized  & $10^5 - 10^7$ & $10^{-4} - 10^{-2}$ & $\approx 2000$ & X-ray and highly ionized metals\\
