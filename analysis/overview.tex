...
\begin{itemize}
\item The \citet{toomre1964} parameter of the galaxy and its evolution,
\item The evolution of the surface density (in particular the gaseous surface density) with time,
\item The evolution of scale height of the disks, as well as the difference between scale height and local \citet{jeans1960} length.
\end{itemize}
